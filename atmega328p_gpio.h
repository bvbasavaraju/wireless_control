...
#ifndef __ATMEGA328P_GPIO_H				// to avoid the multiple definition!
#define __ATMEGA328P_GPIO_H
...
//typedef struct
//{
//	ports		port;			// the port in the ATMEGA328P
...
#endif // end of __ATMEGA328P_GPIO_H
